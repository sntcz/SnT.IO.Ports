...
3. **Isolate the problem** &mdash; ideally create an
   ...
   "Short, Self Contained, Correct (Compilable), Example") and a live example.
...
your environment? What steps will reproduce the issue? What OS and/or framework
experience the problem? Do other OSes show the bug differently? What would 
you expect to be the outcome? All these details will help people to fix 
any potential bugs.
...
>
> A summary of the issue and the OS, framework, Visual Studio environments
...
- Before committing, organize usings for each updated C# source file. Either you can
  right-click editor and select `Organize Usings > Remove and sort`.
- Before committing, run Code Analysis in `Debug` configuration and follow 
  the guidelines to fix CA issues. Code Analysis commits can be made separately.
